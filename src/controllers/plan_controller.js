    ...
    try {
        ...
        return res.send({
            ...
            data3: {
                ...
                allpro: memberDetails12?.house_reward?.filter(item => item.amount == 20 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 40 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 100 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 200 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 500 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 2000 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 4000 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) + memberDetails12?.house_reward?.filter(item => item.amount == 1000 && item.status === undefined).reduce((sum, item) => sum + item.house_reward, 0) +memberDetails12?.level_reward?.filter(item => item.amount == 20 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 40 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 100 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 200 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 500 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 2000 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 4000 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0) + memberDetails12?.level_reward?.filter(item => item.amount == 1000 && item.status === undefined).reduce((sum, item) => sum + item.reward, 0),
