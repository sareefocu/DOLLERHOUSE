...
const getPlanController = async (req, res) => {
    try {
        ...
        if (resp !== null) {
            let memberDetails12 = await rewardModel.findOne({ wallet_id: resp.wallet_id })
            let missmemberDetails12 = await ref.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails123 = await ref40.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails1234 = await ref100.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails12345 = await ref200.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails123456 = await ref500.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails1234567 = await ref1000.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails12345678 = await ref2000.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let missmemberDetails123456789 = await ref4000.aggregate(
                [
                    {
                        $match: {
                            misseduser:
            ...
            let data2 = {
                r20: missmemberDetails12.length,
                r40: missmemberDetails123.length,
                r100: missmemberDetails1234.length,
                r200: missmemberDetails12345.length,
                r500: missmemberDetails123456.length,
                r1000: missmemberDetails1234567.length,
                r2000: missmemberDetails12345678.length,
                r4000: missmemberDetails123456789.length,
            }
            return res.send({
                message: "Your Plan fetched successfully", status: "Ok", data: resp,
                data1: data1,
                data2: data2,
                data3: {
                    ...
                    h1520miss: memberDetails12?.level_reward?.filter(item => item.amount == 20 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),
                    h1540all: memberDetails12?.level_reward?.filter(item => item.amount == 40).reduce((sum, item) => sum + item.reward, 0),
                    h1540miss: memberDetails12?.level_reward?.filter(item => item.amount == 40 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),
                    h15100all: memberDetails12?.level_reward?.filter(item => item.amount == 100).reduce((sum, item) => sum + item.reward, 0),
                    h15100miss: memberDetails12?.level_reward?.filter(item => item.amount == 100 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),
                    h15200all: memberDetails12?.level_reward?.filter(item => item.amount == 200).reduce((sum, item) => sum + item.reward, 0),
                    h15200miss: memberDetails12?.level_reward?.filter(item => item.amount == 200 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),

                    h15500all: memberDetails12?.level_reward?.filter(item => item.amount == 500).reduce((sum, item) => sum + item.reward, 0),
                    h15500miss: memberDetails12?.level_reward?.filter(item => item.amount == 500 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),

                    h151000all: memberDetails12?.level_reward?.filter(item => item.amount == 1000).reduce((sum, item) => sum + item.reward, 0),
                    h151000miss: memberDetails12?.level_reward?.filter(item => item.amount == 1000 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),

                    h152000all: memberDetails12?.level_reward?.filter(item => item.amount == 2000).reduce((sum, item) => sum + item.reward, 0),
                    h152000miss: memberDetails12?.level_reward?.filter(item => item.amount == 2000 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),

                    h154000all: memberDetails12?.level_reward?.filter(item => item.amount == 4000).reduce((sum, item) => sum + item.reward, 0),
                    h154000miss: memberDetails12?.level_reward?.filter(item => item.amount == 4000 && item.status === 'missed Reword').reduce((sum, item) => sum + item.reward, 0),
                    innerAmountSum20: innerAmountSum,
            ...
            return res.status(404).json({
                status: "Not Found",
                message: "Invalid walletid or userid",
            });
        }
    } catch (error) {
        console.log(error)
