...
const getPlanController = async (req, res) => {
  try {
    ...
    const amounts = [20, 40, 100, 200, 500, 1000, 2000, 4000];
    ...
    // Add inner amount sums
    data3.innerAmountSum20 = innerAmountSum20;
    data3.innerAmountSum40 = innerAmountSum40;
    data3.innerAmountSum100 = innerAmountSum100;
    data3.innerAmountSum200 = innerAmountSum200;
    data3.innerAmountSum500 = innerAmountSum500;
    data3.innerAmountSum1000 = innerAmountSum1000;
    data3.innerAmountSum2000 = innerAmountSum2000;
    data3.innerAmountSum4000 = innerAmountSum4000;
    return res.send({
